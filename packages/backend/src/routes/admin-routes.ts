...
router.get('/pending-reviews', requireAuth, requireRole('admin'), async (_req: Request, res: Response) => {
...
router.post('/documents/:id/review', requireAuth, requireRole('admin'), async (req: Request, res: Response) => {
...
router.get('/documents/:id/audit-logs', requireAuth, async (req: Request, res: Response) => {
