...
router.post('/upload-url', requireAuth, requireRole('seller'), async (req: Request, res: Response) => {
...
router.post('/:id/confirm-upload', requireAuth, requireRole('seller'), async (req: Request, res: Response) => {
